...
- [ ] Necesitamos que el código del repo (no solo los datos y permisos)
...
- [ ] Una vez copiado el código, necesitamos que el esquema de la base se
      cree automáticamente, sin que nadie tenga que acordarse de correr algo
      a mano.
